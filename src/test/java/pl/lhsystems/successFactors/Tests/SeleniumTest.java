...
//		webDriver.quit();
	...
	public Object[][] jsonDataProvider(ITestContext context) throws IOException {
		...
		DataResource resource = new InputStreamResource(new FileInputStream(
				"src/test/resources/employee.json"), EMPLOYEE.class, "json");
		SeLionDataProvider dataProvider = DataProviderFactory
				.getDataProvider(resource);
		Object[][] data = dataProvider.getAllData();
		// Object[][] data = dataProvider.getDataByIndex(new int[] {1});
		// //ustawic ten test_param
		return data;
	}
}
